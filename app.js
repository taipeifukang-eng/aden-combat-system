...
const MODULES = {
    ...
    eq_tshirt: ['物理防禦力', '力量', '敏捷', '傷害減免', '昏迷抗性', '近距離命中', '近距離傷害', 'PVP附加傷害', 'PVP傷害減免', '昏迷命中'],
    eq_badge: ['物理防禦力', '最大HP', 'PVP傷害減免', '昏迷命中', '昏迷抗性'],
    eq_shoulder: ['物理防禦力', '近距離命中', '近距離傷害', '力量', '傷害減免', '昏迷命中', '昏迷抗性'],
    eq_weapon: ['近距離命中', '近距離傷害', '力量', '傷害增加', '無視近距離迴避力', '昏迷命中', '無視近距離傷害減免'],
    ...
    eq_gloves: ['物理防禦力', '近距離命中', '近距離傷害', '力量', '昏迷命中', '傷害減免', 'PVP傷害減免', '爆擊傷害減免'],
    eq_pants: ['物理防禦力', '力量', '傷害減免', 'PVP傷害減免', '無視傷害減免', '持續傷害減少', '最大HP', '近距離命中', '爆擊傷害減免'],
    ...
    eq_necklace: ['物理防禦力', '力量', '最大HP', '近距離迴避力', '無視近距離迴避力', '昏迷命中', '昏迷抗性', '藥水恢復率', '藥水恢復量'],
    ...
    eq_rune2: ['物理防禦力', '昏迷命中', '無視近距離傷害減少', '藥水恢復率', '無視近距離迴避力', '昏迷抗性', '近距離命中', '近距離傷害', '藥水恢復量', '力量'],
