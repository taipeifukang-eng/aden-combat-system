...
const MODULES = {
    ...
    eq_armguard: ['物理防禦力', '近距離傷害', '力量', '傷害減免', '昏迷命中', '爆擊傷害減免', '最大HP'],
    ...
    eq_belt: ['物理防禦力', '力量', '傷害減免', '最大HP', '近距離爆擊抗性', '昏迷命中', '無視傷害減免', '藥水恢復率'],
    ...
    eq_bracelet2: ['物理防禦力', '敏捷', '力量', '移動速度', '昏迷命中', '最大HP', '藥水恢復率', '藥水恢復量', '近距離爆擊', '攻擊速度', '無視近距離迴避力'],
